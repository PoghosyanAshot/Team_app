    ...
    createChannel: {
        params: Joi.object({
            workspaceId: Joi.string()
                ...
                .messages({
                    [JOI_KEYS.REQUIRED]:
                        MESSAGES.VALIDATION.CHANNEL.WORKSPACE_REQUIRED,
            ...
            members: Joi.array()
                .items(
                    Joi.string()
                        ...
                        .messages({
                            [JOI_KEYS.PATTERN]:
                                MESSAGES.VALIDATION.GENERAL.INVALID_ID,
                        }),
                )
                .unique(),
        }),
